      ...
      <header className='flex flex-col gap-2 w-full px-4 z-50'>
        <div className='relative z-50'>
          <form className='relative flex justify-center items-center w-[20.5rem] h-6 rounded-lg m-auto'>
            ...
            <button 
              type ='submit'
              className='text-xs bg-slate-900 text-slate-300 w-[2.5rem] h-6 px-2 py-1 rounded-r-lg text-center absolute right-0 hover:bg-slate-700'>검색</button>
          </form>
              ...
              포켓몬이 없습니다. 
                ...
                <div className='text-center'>
                  <button 
                    ...
                    className='bg-slate-800 px-6 py-2 y-4 text-base rounded-lg font-bold text-white'></button>
                    더 보기
                </div>
